...
def main():
    ...
    # Dataset
    parser.add_argument('--dataset', type=str, choices = ['regression_synth', 'classification_synth', 'MNIST', 'CIFAR10', 'CIFAR10aug', 'tidigits','dvsgesture'], default='dvsgesture', help='Choice of the dataset: synthetic regression (regression_synth), synthetic classification (classification_synth), MNIST (MNIST), CIFAR-10 (CIFAR10), CIFAR-10 with data augmentation (CIFAR10aug). Synthetic datasets must have been generated previously with synth_dataset_gen.py. Default: MNIST.')
    # Training
    ...
    parser.add_argument('--epochs', type=int, default=10000, help='Number of training epochs Default: 100.')
    ...
    # Network
    #CONV_32_5_1_2_FC_1000_FC_10 C_100_3_1_1_FC_1000_FC_10
    parser.add_argument('--topology', type=str, default='CONV_32_5_1_2_FC_1000_FC_11', help='Choice of network topology. Format for convolutional layers: CONV_{output channels}_{kernel size}_{stride}_{padding}. Format for fully-connected layers: FC_{output units}.')#CONV_8_3_1_1_FC_100_FC_10 'FC_30_FC_10';;'CONV_32_5_1_2_FC_1000_FC_10'
